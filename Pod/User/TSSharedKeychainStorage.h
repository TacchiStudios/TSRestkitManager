...
// Store the credentials in a shared keychain group so that the data can be shared between applications in the same group. This is for SSO.
@property (nonatomic, copy, nonnull) NSString *accessGroup;
